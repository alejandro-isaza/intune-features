...
class NetworkEval {
    ...
    init(configuration: Configuration, networkFile: String, audioFile: String, midiFile: String, outputFile: String?) {
    ...
    func run() {
        ...
        let neuralNet = try! NeuralNet(networkFile: networkFile, configuration: configuration)
