...
public enum Table: String {
    ...
    public func maxDims(_ configuration: Configuration) -> [Int] {
    ...
    public func chunkDimensions(_ chunkSize: Int, configuration: Configuration) -> [Int] {
        let featureSize = configuration.bandCount
    ...
    public func createInFile(_ file: File, chunkSize: Int, configuration: Configuration) {
        let dims = [Int](repeating: 0, count: rank)
